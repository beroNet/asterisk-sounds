...
// +--------------------------------------------------
    ...
    $fm_root_atual="/apps/asterisk_sounds/";
// +--------------------------------------------------
// | Config
// +--------------------------------------------------
    $cfg = new config();
    ...
    if (!isset($dir_atual)){
        ...
        $dir_atual="/apps/asterisk_sounds/";
...
function tree($dir_antes,$dir_corrente,$indice){
    ...
    $is_proibido=true;
    if (
        $dir_corrente == "/apps/asterisk_sounds/etc" || 
        $dir_corrente == "/apps/asterisk_sounds/etc/asterisk" || 
        ...
        $dir_corrente == "/apps/asterisk_sounds/" 
    ){
        $is_proibido = false;
    }
